...
public class Admin extends JFrame {
    ...
    Admin() {
		...
		*/
        ...
        label1.setBounds(223, 100, 433, 50);
        label1.setFont(f1);
        c.add(label1);
        ...
        btn4.setBounds(399, 160, 270, 50);
        btn4.setFont(f2);
        btn4.setCursor(cursor);
        btn4.setForeground(Color.WHITE);
        btn4.setBackground(Color.decode("#2B0EDB"));
        c.add(btn4);
